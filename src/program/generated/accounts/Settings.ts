...
export class Settings implements SettingsArgs {
  private constructor(
    ...
    readonly operatorAuthority: web3.PublicKey,
    readonly collectionMint: web3.PublicKey,
    readonly nextTokenId: beet.bignum,
  ...
  static gpaBuilder(
    programId: web3.PublicKey = new web3.PublicKey(
      'EqZ2b3VrYYH426eJ5MnAHs5QGuHXmpTzTHCPsoX9ETMf'
    )
  ) {
  ...
  pretty() {
    return {
      ...
      operatorAuthority: this.operatorAuthority.toBase58(),
      collectionMint: this.collectionMint.toBase58(),
      nextTokenId: (() => {
        const x = <{ toNumber: () => number }>this.nextTokenId
...
>(
  [
    ...
    ['operatorAuthority', beetSolana.publicKey],
    ['collectionMint', beetSolana.publicKey],
    ['nextTokenId', beet.u64],
